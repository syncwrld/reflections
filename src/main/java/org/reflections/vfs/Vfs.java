 ...
 *
 * <p>use the {@link org.reflections.vfs.Vfs#fromURL(java.net.URL)} to get a {@link
 * org.reflections.vfs.Vfs.Dir}, then use {@link org.reflections.vfs.Vfs.Dir#getFiles()} to iterate
 * over the {@link org.reflections.vfs.Vfs.File}
 *
 * <p>for example:
 *
 * <pre>
 ...
 * </pre>
 *
 * <p>{@link org.reflections.vfs.Vfs#fromURL(java.net.URL)} uses static {@link
 * org.reflections.vfs.Vfs.DefaultUrlTypes} to resolve URLs. It contains VfsTypes for handling for
 * common resources such as local jar file, local directory, jar url, jar input stream and more.
 *
 * <p>It can be plugged in with other {@link org.reflections.vfs.Vfs.UrlType} using {@link
 * org.reflections.vfs.Vfs#addDefaultURLTypes(org.reflections.vfs.Vfs.UrlType)} or {@link
 * org.reflections.vfs.Vfs#setDefaultURLTypes(java.util.List)}.
 *
 * <p>for example:
 *
 * <pre>
 ...
 * </pre>
 *
 * <p>use {@link org.reflections.vfs.Vfs#findFiles(java.util.Collection,
 * java.util.function.Predicate)} to get an iteration of files matching given name predicate over
 * given list of urls
 */
public abstract class Vfs {
  ...
  /**
   * the default url types that will be used when issuing {@link
   * org.reflections.vfs.Vfs#fromURL(java.net.URL)}
   */
    ...
    for (UrlType type : urlTypes) {
      try {
        ...
        if (Reflections.log != null) {
          Reflections.log.warning(
              "could not create Dir using "
                  + type
                  + " from url "
                  + url.toExternalForm()
                  + ". skipping. ["
  ...
  /**
   * return an iterable of all {@link org.reflections.vfs.Vfs.File} in given urls, starting with
   * given packagePrefix and matching nameFilter
   */
  public static Iterable<File> findFiles(
      final Collection<URL> inUrls,
      final String packagePrefix,
      final Predicate<String> nameFilter) {
    Predicate<File> fileNamePredicate =
        file -> {
  ...
  /**
   * return an iterable of all {@link org.reflections.vfs.Vfs.File} in given urls, matching
   * filePredicate
   */
  public static Iterable<File> findFiles(
      final Collection<URL> urls, final Predicate<File> filePredicate) {
    return () ->
        urls.stream()
            .flatMap(
                url -> {
   ...
   *
   * <p>jarUrl - creates a {@link org.reflections.vfs.ZipDir} over a jar url, using Java's {@link
   * JarURLConnection}
   *
   ...
   *
   * <p>jarInputStream - creates a {@link JarInputDir} over jar files (contains ".jar!/" in it's
   * name), using Java's JarInputStream
   */
